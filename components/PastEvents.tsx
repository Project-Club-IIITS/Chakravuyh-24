...
export function PastEvents() {
  return (
    <div className="flex flex-col gap-2">
      <h1 className="text-5xl text-purple-500 font-bold text-center my-4">Past Events</h1>
...
const Skeleton = ({imageUrl}:{imageUrl:string}) => (
  <div className="flex flex-1 w-full h-full min-h-[10rem] rounded-xl bg-gradient-to-br from-neutral-200 dark:from-neutral-900 dark:to-neutral-800 to-neutral-100">
    <Image width={300} height={300}  className="w-full h-full object-cover object-top" alt="iamge" src={imageUrl} />
  </div>
);
const items = [
  {
